...
public class Visit {
    ...
    private MedicalCard medicalCardByMedicalCardId;
    ...
    public MedicalCard getMedicalCardByMedicalCardId() {
        return medicalCardByMedicalCardId;
    }

    public void setMedicalCardByMedicalCardId(MedicalCard medicalCardByMedicalCardId) {
        this.medicalCardByMedicalCardId = medicalCardByMedicalCardId;
    }
}
